...
const SQUARE_LOCATION_ID = "L2N0S3FA7EX8B"; // Production location ID
  ...
  shop: router({
    ...
    createCheckout: protectedProcedure
      ...
      .mutation(async ({ input, ctx }) => {
        ...
        const response = await squareClient.checkout.paymentLinks.create({
          ...
          checkoutOptions: {
            redirectUrl: `https://luckyslots-aynovan9.manus.space/checkout-success?purchaseId=${purchase?.id}`,
          },
        });
    ...
    getHttpsRedirectUrl: publicProcedure
      ...
      .query(({ input }) => {
        ...
        const baseUrl = "https://luckyslots-aynovan9.manus.space";
