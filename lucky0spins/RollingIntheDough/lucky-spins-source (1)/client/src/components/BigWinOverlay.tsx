  ...
  return (
    <div
      ...
      style={{
        ...
        animation: exiting ? "fadeOut 0.4s ease-out forwards" : "fadeIn 0.3s ease-out forwards",
      }}
    >
      {/* Starburst rays */}
      ...
      <div className="relative z-10 flex flex-col items-center gap-4 px-8 text-center select-none">
        ...
        <div
          ...
          style={{
            ...
            animation: "winLabelPop 0.5s cubic-bezier(0.175, 0.885, 0.32, 1.275) 0.2s both",
        ...
        >
          +<AnimatedCounter target={winAmount} duration={winType === "JACKPOT" ? 3000 : 1500} /> 🪙
        </div>
        ...
        <div
          ...
          style={{
            ...
            animation: "tapPulse 1.5s ease-in-out 1s infinite",
          }}
        >
          Tap to continue
        </div>
